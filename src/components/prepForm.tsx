...
export default function PrepForm() {
    ...
    const onSubmit: SubmitHandler<IFormInput> = (data: IFormInput) => dispatch(getPrep(data));

    return (
        <>
            <Typography variant="h5" sx={{ mt: "3rem", mb: "1rem" }} align="center">
                Fill out the details for your diet and generate away!
            </Typography>
                        ...
                        <div>
                            ...
                            <TextField
                                ...
                                {calories.map((calorie) => (
                                    <option key={calories.indexOf(calorie)} value={calorie}>
                                        {calorie}
                                    </option>
                                ))}
                            </TextField>
                        ...
                        <div>
                            ...
                            <TextField
                                ...
                                {allergies.map((allergy) => (
                                    <option key={allergies.indexOf(allergy)} value={allergy}>
                                        {allergy}
                                    </option>
                                ))}
                            </TextField>
                        ...
                        <div>
                            ...
                            <TextField
                                ...
                                {countries.map((country) => (
                                    <option key={countries.indexOf(country)} value={country}>
                                        {country}
                                    </option>
                                ))}
                            </TextField>
                        </div>
                        <Button type="submit" color="primary" size="large" fullWidth sx={{ mt: 2 }}>
                            Generate
                        </Button>
                    </form>
                </Grid>
            ...
            <Typography variant="body1" sx={{ mt: "1rem" }} align="center">
